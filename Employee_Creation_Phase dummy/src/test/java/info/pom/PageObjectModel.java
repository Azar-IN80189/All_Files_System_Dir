...
public class PageObjectModel extends BaseClass {
	...
	public void setDbiconclick(WebElement dbiconclick) {
		this.dbiconclick = dbiconclick;
	}
	public void setDbmovecursor(WebElement dbmovecursor) {
		this.dbmovecursor = dbmovecursor;
	}
	public void setDbnameclick(WebElement dbnameclick) {
		this.dbnameclick = dbnameclick;
	}
...
//staffallowance
	...
	@FindBy(xpath = "//input[contains(@id,'chkETMSIsApprover')]")
	public WebElement EtmsApprover;

	@FindBy(xpath = "//input[contains(@id,'chkELEAVEIsApprover')]")
	public WebElement ELeaveApprover;
	
	@FindBy(xpath = "//input[contains(@id,'chkECLAIMIsApprover')]")
	public WebElement EclaimApprover;

	@FindBy(xpath = "//input[contains(@id,'chkEPAYROLLIsApprover')]")
	public WebElement EpayrollApprover;
	
	@FindBy(xpath = "//input[contains(@id,'chkMOBILEATTENDANCEIsApprover')]")
	public WebElement EmobileAttendaceApprover;
	
	@FindBy(xpath = "//input[contains(@id,'chkEAPPRAISALIsApprover')]")
	public WebElement EAppraisalApprover;
