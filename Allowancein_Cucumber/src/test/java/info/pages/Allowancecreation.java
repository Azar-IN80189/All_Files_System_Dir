...
public class Allowancecreation extends Reusableclass {
	...
	public void user_need_to_give_allowance_details_from_given_sheetname_rownumber(String SheetName, Integer RowNumber)
		...
		List<Map<String, String>> Allowancecode = reader.getData(
				"src/test/resources/Excel/Allowance.xlsx",
				SheetName);
	...
	@When("Map allowance to particular employee from given sheetname {string} and RowNumber {int}")
	public void map_allowance_to_particular_employee_from_given_sheetname_and_row_number(String SheetName,
			Integer RowNumber) throws InvalidFormatException, IOException, InterruptedException, AWTException {
		...
		List<Map<String, String>> empName = reader.getData(
				"src/test/resources/Excel/Allowance.xlsx",
				SheetName);
		String EName = empName.get(RowNumber).get("Empname");
		...
		List<Map<String, String>> Allowanceone = reader.getData(
				"src/test/resources/Excel/Allowance.xlsx",
				SheetName);
		String Al1 = Allowanceone.get(RowNumber).get("Allowance1");
		tofill(st.box1, Al1);
		todown();
		toenter();
		...
		List<Map<String, String>> Allowancetwo = reader.getData(
				"src/test/resources/Excel/Allowance.xlsx",
				SheetName);
		String Al2 = Allowancetwo.get(RowNumber).get("Allowance2");
		tofill(st.box2, Al2);
		todown();
		toenter();
