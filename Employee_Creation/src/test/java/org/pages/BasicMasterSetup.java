...
public class BasicMasterSetup extends Reusableclass{
	PageObjectModel s;
	
	static PageObjectModel p;
	...
	public void user_need_to_Create_the_Shift_for_the_employee_and(String SheetName, Integer RowNumber) throws IOException, InterruptedException, InvalidFormatException {
		...
		s.Username.sendKeys(email);
		Thread.sleep(500);
		s.password.sendKeys(password);
		toClick(s.click);
	}
		/*implicitwait();
		driver.findElement(By.xpath("//img[@src='../../../Artifacts/images/ChangeCustomer.svg']")).click();
		Thread.sleep(300);
		//List<Map<String,String>> testData1=reader.getData("src/test/resources/Excel/Automation.xlsx", SheetName);
		String Dbname = testData.get(RowNumber).get("DBName");
		s.DBname.sendKeys(Dbname);
...
*/
	...
	@Given("User need to create the department {string} and {int}")
	public void user_need_to_create_the_department_and(String SheetName, Integer RowNumber) throws IOException, InvalidFormatException, InterruptedException {
	...
	public void user_entered_Dept_code_and_Dept_name_and(String SheetName, Integer RowNumber) throws IOException, InvalidFormatException {
		ExcelReader reader=new ExcelReader();
		s = new PageObjectModel();
		List<Map<String,String>> testData=reader.getData("src/test/resources/Excel/Automation.xlsx", SheetName);
		String deptcode = testData.get(RowNumber).get("BasicDepartmentcode");
		String deptname = testData.get(RowNumber).get("BasicDepartmentname");
	...
	public void user_need_to_click_save_to_create_a_Department() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void user_need_to_create_the_designation() {
		implicitwait();
		tomovethecursor(s.Master);
		tomovethecursor(s.BasicMasterSetup);
	...
	public void user_entered_designation_code_and_designation_name_and(String SheetName, Integer RowNumber) throws IOException, InvalidFormatException {
		ExcelReader reader=new ExcelReader();
		s = new PageObjectModel();
		List<Map<String,String>> testData=reader.getData("src/test/resources/Excel/Automation.xlsx", SheetName);
		String designationcode = testData.get(RowNumber).get("BasicDesignationcode");
		String designationname = testData.get(RowNumber).get("BasicDesignationname");
		implicitwait();
	...
	public void user_have_to_click_save_to_create_a_designation() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void user_need_to_create_a_section() {
		implicitwait();
		tomovethecursor(s.Master);
		tomovethecursor(s.BasicMasterSetup);
		implicitwait();
	...
	public void user_entered_section_code_and_section_name_and(String SheetName, Integer RowNumber) throws IOException, InvalidFormatException, AWTException {
		implicitwait();
		ExcelReader reader=new ExcelReader();
		s = new PageObjectModel();
		List<Map<String,String>> testData=reader.getData("src/test/resources/Excel/Automation.xlsx", SheetName);
		String sectioncode = testData.get(RowNumber).get("BasicSectioncode");
		String sectionname = testData.get(RowNumber).get("BasicSectionname");
		implicitwait();
		...
		String SectionDepartment = testData.get(RowNumber).get("BasicDepartmentname");
	...
	public void user_need_to_create_a_category() {
		tomovethecursor(s.Master);
		tomovethecursor(s.BasicMasterSetup);
		implicitwait();
	...
	public void user_entered_category_code_and_category_name_and(String SheetName, Integer RowNumber) throws IOException, InvalidFormatException {
		implicitwait();
		ExcelReader reader=new ExcelReader();
		s= new PageObjectModel();
		List<Map<String,String>> testData=reader.getData("src/test/resources/Excel/Automation.xlsx", SheetName);
		String categorycode = testData.get(RowNumber).get("BasicCategorycode");
		String  categoryname = testData.get(RowNumber).get("BasicCategoryname");
		implicitwait();		
	...
	public void user_need_to_click_save_to_create_a_category() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void user_need_to_create_the_designation_group() {
		implicitwait();
		tomovethecursor(s.Master);
		tomovethecursor(s.BasicMasterSetup);
		implicitwait();
	...
	public void user_entered_designationgroupcode_and_designationgroupname_and(String SheetName, Integer RowNumber) throws IOException, InvalidFormatException {
		implicitwait();
		ExcelReader reader=new ExcelReader();
		s = new PageObjectModel();
		List<Map<String,String>> testData=reader.getData("src/test/resources/Excel/Automation.xlsx", SheetName);
		String designationgroupcode = testData.get(RowNumber).get("BasicDesignationgroupcode");
		String  designationgroupname = testData.get(RowNumber).get("BasicDesignationgroupname");
		implicitwait();		
